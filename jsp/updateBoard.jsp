...
<script type="text/javascript">
	$(function(){
		...
		$.ajax("joincheckBoxCity",{success:function(data){
			var arr = eval("("+data+")");
			var bbregion = $("#bregion").val();
			$.each(arr, function(i,g){ 
				var city_name_kor = g.city_name_kor;
				if (bbregion == city_name_kor	){
					$('#cityno').append('<option value="'+city_name_kor+'"selected>'+city_name_kor+'</option>').prop("selected",true);		
				}
				else{
					$('#cityno').append('<option value="'+city_name_kor+'" >'+city_name_kor+'</option>');	
				}	
			});
		}});
...
<section>
	<div class="top-img-sect-b">
		<img alt="" src="resources/img/eu.jpg"> 
	...
	<div class="center">
		<div class="board-form-container">
			...
			<input type="hidden" value="${b.b_region }" id="bregion">
		    <div class="insert-row">
		      <div class="label-15">
		        <label for="title">제목</label>
		      </div>
		      <div class="input-40">
		        <input type="text" id="title" name="b_title" value="${b.b_title }">
		      </div>
		    </div>
		    <div class="insert-row">
		      <div class="label-15">
		      ...
		      <div class="input-40">
		        <input type="text" id="name" name="m_name" value="${b.m_name }">
		      </div>
		    </div>
		    <div class="insert-row">
		      <div class="label-15">
		      ...
		      <div class="input-40">
		        <select id="cityno" name="b_region"  value="${b.b_region }">
		        </select>
		      </div>
		     </div>
		    <div class="insert-row">
		      	<div class="label-15">
		        	<label for="date">여행일정</label>
		      	</div>
		      	<div class="input-80">
					<input type="date" id="date" name="b_startday" value="${b.b_startday }">
					<span id="dateCon">-</span>
					<input type="date" id="date" name="b_endday" value="${b.b_endday }">
		      	</div>
		    </div>
		    <div class="insert-row">
		      <div class="label-15">
		      ...
		      <div class="input-80">
		        <textarea id="subject" name="b_content" placeholder="내용을 입력하세요." style="height:200px">${b.b_content }</textarea>
		      </div>
		    </div>
			    <div class="insert-row">
