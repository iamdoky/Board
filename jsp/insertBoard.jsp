...
<section>
	<div class="top-img-sect-b">
		<img alt="" src="resources/img/shaghai.jpg"> 
		<div class="img_content">
	  		<h1>함께 할 여행 정보 입력</h1>
		</div>
	</div>
	<form action="insertBoard.do" method="post">
	<input type="hidden" id="mno" name="m_no" >
	<div class="center">
		<div class="board-form-container">
		    ...
		    <div class="insert-row">
		      <div class="label-15">
		        <label for="b_pwd">암호</label>
		      </div>
		      <div class="input-40">
		        <input type="password" id="b_pwd" name="b_pwd" required>
		      </div>
		    </div>
		    <div class="insert-row">
		      <div class="label-15">
		        <label for="b_region">여행지</label>
		      </div>
		      <div class="input-40">
		        <select id="cityno" name="b_region" required>
		        </select>
		      </div>
		     </div>
		    <div class="insert-row">
		      	<div class="label-15">
		        	<label for="b_startday">여행시작일</label>
		      	</div>
		      	<div class="input-80">
					<input type="date" id="b_startday" name="b_startday" required>
					<span id="dateCon">-</span>
		      	</div>
		    </div>
		    <div class="insert-row">
		      	<div class="label-15">
		        	<label for="b_endday">여행종료일</label>
		      	</div>
		      	<div class="input-80">
					<input type="date" id="b_endday" name="b_endday" required>
					<span id="dateCon"></span>
		      	</div>
		    </div>
		    <div class="insert-row">
